...
st.set_page_config(page_title="Phân loại nấm",)
def main():
    st.title("Phân loại nhị phân")
    st.sidebar.title("Phân loại nhị phân")
    st.markdown("Dong: Nấm này ăn được hay không? 🍄")
    st.sidebar.markdown("Dong: Nấm này ăn được hay không? 🍄")
